 ...
 * @author James
 */
public class ErrorHandlerTypeHandler implements BaseTypeHandler {

    @Override
    public Object convertType(String input) {
        Object errorType = ReflectUtil.createNewInstance(input);
        if (errorType instanceof ErrorHandler) {
            return errorType;
        }
        return null;
    }
