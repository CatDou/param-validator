 ...
 * @author James
 */
public class ErrorHandlerGlobalTest implements ErrorHandler {
    ...
    public void handler(HttpServletRequest request, HttpServletResponse response, ValidateResult validateResult) {
        ...
        checkMap.put("code", 102);
        checkMap.put("data", validateResult);
        HttpUtil.printObject(response, checkMap);
    }
}
