 ...
 * @author James
 */
public class ComplexJsonValidator implements ParamValidator {
    private ValidatorLog LOG = ValidatorLogFactory.getLogger(ComplexJsonValidator.class);

    @Override
    public ValidateResult validate(InputParam inputParam, CheckRule checkRule) {
        LOG.info(JSON.toJSONString(inputParam));
